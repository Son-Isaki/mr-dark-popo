const Options = window.Options = {
    ...
    OPTIONS: {
        ...
        showUseFioleInActions: 'show-use-fiole-actions',
        showGoToObjMarketActions: 'show-obj-market-actions',
        showGoToCapsMarketActions: 'show-caps-market-actions',
    ...
    OPTIONS_LABEL: {
        ...
        showUseFioleInActions: 'Ajouter un bouton d\'action rapide pour utiliser une fiole sur le personnage en cours',
        showGoToObjMarketActions: 'Ajouter un bouton d\'action rapide pour aller au marché aux objets',
        showGoToCapsMarketActions: 'Ajouter un bouton d\'action rapide pour aller au marché aux capsules',
